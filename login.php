 ...
 * Customer Login Page
 *
 * Handles user authentication for the Turfmate system. Users enter their
 * email and password; if valid, they are logged in and redirected to the
 * game selection dashboard. If credentials are invalid, an error message
 * is displayed.
 *
 * This script does not use hashed passwords (plain text comparison),
