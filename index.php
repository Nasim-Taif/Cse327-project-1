...
// Include page layout header and navigation components
...
<section class="home-container">
    ...
    <!-- CTA button leading to game selection page -->
    <a href="select_game.php" class="book-btn">Book Now!</a>

    <!-- Display sample sports gallery -->
...
<!-- About section providing brief system description -->
<section id="about" class="about-section">
    <h2>About Turfmate</h2>
    <p>
        Turfmate is a modern platform to book sports facilities easily and securely.
    </p>
</section>
